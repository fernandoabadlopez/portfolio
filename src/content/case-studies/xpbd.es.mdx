...
## Respuesta elástica: estirando desde el centro

Con las cuatro esquinas fijas, tiré de la tela desde su punto central. La energía se disipa y la malla vuelve al reposo sin colapsar.

<VisualPlaceholder
  kind="inline"
  src="/assets/xpbd/center-bounce.mp4"
  description="Tela estirada desde el centro con las cuatro esquinas fijas, rebotando de vuelta al reposo."
/>

## Links

- Repositorio: [github.com/fernandoabadlopez/xpbd](https://github.com/fernandoabadlopez/xpbd)
- Vídeo de demostración: [youtube.com/watch?v=UIyvQkdy5wY](https://www.youtube.com/watch?v=UIyvQkdy5wY)
